...
inquirer.prompt(QUESTIONS)
  .then(answers => {
    ...
    let answersNew: any = Object.assign({}, answers, yargs.argv);
...
function isEnvExample(options: CliOptions) {
  return fs.existsSync(path.join(options.templatePath, '.env-example'));
}
